...
class BarChartSample1 extends StatefulWidget {
  ...
  Colors.white;
  final Color barColor =Color.fromRGBO(255, 221, 217, 1) ;
  final Color touchedBarColor = Color.fromRGBO(117, 48, 39, 1);
...
class BarChartSample1State extends State<BarChartSample1> {
  ...
  List<BarChartGroupData> showingGroups() => List.generate(7, (i) {
    switch (i) {
      ...
      case 5:
        return makeGroupData(5, 23, isTouched: i == touchedIndex);
      case 6:
        return makeGroupData(6, 11, isTouched: i == touchedIndex);
      default:
        return throw Error();
    }
  });
  ...
  Widget getTitles(double value, TitleMeta meta) {
    const style = TextStyle(
      color:  Color.fromRGBO(255, 221, 217, 1) ,
      fontWeight: FontWeight.bold,
      fontSize: 14,
    );
    Widget text;
